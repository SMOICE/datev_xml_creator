...
$invoice = new Model_Invoice(new DateTime('2020-03-04'), 3657, 'Lieschen Müller', 'EUR');
$invoice->addDetail(new Model_InvoiceDetail(2975, 19));

try {
  $creator = new Creator_DocumentPackage($invoice, "ausgangsrechnung_01.pdf", "example_01.zip");
  $creator->createOutput();
} catch (Exception_DocumentCreator $e) {
  echo $e->getMessage()."\n";
}
